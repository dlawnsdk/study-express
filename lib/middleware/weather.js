const getWeatherData = () =>[
    {
        ...
        forecastUrl: 'https://api.weater.gov/gridpoints/PQR/112,103/forecast',
        iconUrl: 'https://api.weather.gov/icons/land/day/tsra,40?size=medium',
        weather: 'Cnace Showers And Thunderstorms',
        temp: '59 F'
    },
    {
        location:{
        ...
        forecastUrl: 'https://api.weater.gov/gridpoints/PDT/34,40/forecast',
    ...
    },
    {
        ...
        iconUrl: 'https://api.weater.gov/icons/land/day/tsra,90?size=medium',
